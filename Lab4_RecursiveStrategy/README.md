...
1. long int would be the bigger data type to use for computing a larger factorials.
2. Anything after 12 would show indication of overflow and the fucntion would have start producing inconsistence value.
